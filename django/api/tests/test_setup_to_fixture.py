...
class SetupToFixtureCommandTest(TestCase):
    ...
    def test_command_success(self, mock_call_command, mock_importlib, mock_teardown, mock_setup):
        ...
        cmd = Command()
        cmd.handle(test_class_path='fake.module.MockTestCase', fixture_name='test_fixture.json')
    ...
    @patch.object(cmd_mod, 'importlib')
    @patch.object(cmd_mod, 'call_command')
    def test_command_without_json_extension(self, mock_call_command, mock_importlib, mock_teardown, mock_setup):
        mock_setup.return_value = 'old_config'
        mock_module = MagicMock()
        mock_test_class = MagicMock()
        mock_test_instance = MagicMock()
        ...
        cmd = Command()
        cmd.handle(test_class_path='fake.module.MockTestCase', fixture_name='test_fixture')
    ...
    @patch.object(cmd_mod, 'teardown_databases')
    @patch.object(cmd_mod, 'importlib')
    def test_command_exception_handling(self, mock_importlib, mock_teardown, mock_setup):
        mock_setup.return_value = 'old_config'
        mock_module = MagicMock()
        mock_test_class = MagicMock()
    ...
    @patch.object(cmd_mod, 'importlib')
    @patch.object(cmd_mod, 'call_command')
    def test_command_without_pre_setup(self, mock_call_command, mock_importlib, mock_teardown, mock_setup):
        mock_setup.return_value = 'old_config'
        mock_module = MagicMock()
        mock_test_class = MagicMock()
