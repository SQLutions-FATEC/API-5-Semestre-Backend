...
class SmartMigrateCommandTest(TestCase):
    ...
    def test_database_empty_with_from_scratch_dir(self, mock_file, mock_exists, mock_call_command, mock_connection):
        # Configurar mocks
        ...
        self.assertIn("Configurando o Django para usar a migração 'from scratch'", output)
    ...
    @patch('api.management.commands.smart_migrate.call_command')
    @patch('api.management.commands.smart_migrate.os.path.exists')
    def test_database_empty_without_from_scratch_dir(self, mock_exists, mock_call_command, mock_connection):
        # Configurar mocks
        mock_connection.introspection.table_names.return_value = ['django_migrations'] # Considerado vazio
    ...
    def test_database_not_empty(self, mock_call_command, mock_connection):
        ...
        mock_connection.introspection.table_names.return_value = ['django_migrations', 'api_projeto']
