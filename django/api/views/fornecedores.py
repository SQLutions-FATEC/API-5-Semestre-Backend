...
def fornecedor_pedidos_api(request, id_fornecedor):
    ...
    compras = compras.order_by('-data_pedido__ano', '-data_pedido__mes', '-data_pedido__dia')
    ...
    for compra in compras:
        ...
        if data_previsao and data_atual > data_previsao and status_normalizado not in {'entregue', 'cancelado', 'parcialmente entregue'}:
            is_atrasado = True
