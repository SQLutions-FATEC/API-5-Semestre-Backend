...
urlpatterns = [
    ...
    path(
        'api/<str:programa_cod>/projetos/busca/',
        busca_projetos,
        name='busca-projetos-programa',
    ),
    path(
        'api/projetos/<str:codigo_projeto>/',
        projeto_dashboard_api,
        name='projeto-detalhe',
    ),
    path(
        'api/projetos/<str:codigo_projeto>/compras/',
        compras_projeto_api,
        name='compras_projeto',
    ),
    path(
        'api/projetos/<str:codigo_projeto>/gastos/evolucao/',
        evolucao_gastos_api,
        name='evolucao-gastos',
    ),
    path('api/empenhos-programa/', empenhos_programa, name='empenhos-programa'),
    path(
        'api/<str:programa_cod>/projetos/',
        projeto_sem_filtro,
        name='projeto-sem-filtro',
    ),
    ...
    path(
        'api/projetos/<str:codigo_projeto>/estoque/sobras/',
        otimizacao_sobras_api,
        name='projeto-estoque-sobras',
    ),
    path(
        'api/fornecedores/<str:id_fornecedor>/',
        fornecedor_api,
        name='fornecedor-detalhe',
    ),
    path(
        'api/fornecedores/<str:id_fornecedor>/pedidos/',
        fornecedor_pedidos_api,
