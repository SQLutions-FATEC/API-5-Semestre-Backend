...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(f'Exportando dados do app "api" para a fixture: {filename}...')
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS(f'✅ Sucesso! Fixture "{filename}" criada e pronta para uso nos testes.'))
            self.stdout.write(self.style.WARNING(f'Dica: Adicione `fixtures = ["{name}.json"]` na sua classe de teste!'))
