...
def setup_mock_gastos(
    mock_fato_compra, mock_get_object, dados_gastos, ano_inicio=2024, mes_inicio=1
):
...
class TestComprasProjetoAPI:
    ...
    def test_dias_previstos_calculados_corretamente(
        self, mock_get_object, mock_fato_compra, rf
    ):
    ...
    def test_pedido_emissao_igual_previsao_tem_zero_dias(
        self, mock_get_object, mock_fato_compra, rf
    ):
        setup_mock_compras(
            mock_fato_compra,
    ...
    def test_datas_formatadas_como_string_iso(
        self, mock_get_object, mock_fato_compra, rf
    ):
        setup_mock_compras(
            mock_fato_compra,
    ...
    def test_campos_originais_preservados_no_retorno(
        self, mock_get_object, mock_fato_compra, rf
    ):
        setup_mock_compras(
            mock_fato_compra,
    ...
    def test_tempo_medio_com_dois_pedidos(self, mock_get_object, mock_fato_compra, rf):
        ...
        setup_mock_compras(
            ...
            [
                criar_mock_compra(
                    "PED01", emissao=date(2024, 1, 1), previsao=date(2024, 1, 11)
                ),
                criar_mock_compra(
                    "PED02", emissao=date(2024, 1, 1), previsao=date(2024, 1, 21)
                ),
            ],
        )
    ...
    def test_tempo_medio_arredondado_a_dois_decimais(
        self, mock_get_object, mock_fato_compra, rf
    ):
        ...
        setup_mock_compras(
            ...
            [
                criar_mock_compra(
                    "P1", emissao=date(2024, 1, 1), previsao=date(2024, 1, 4)
                ),  # 3 dias
                criar_mock_compra(
                    "P2", emissao=date(2024, 1, 1), previsao=date(2024, 1, 5)
                ),  # 4 dias
                criar_mock_compra(
                    "P3", emissao=date(2024, 1, 1), previsao=date(2024, 1, 5)
                ),  # 4 dias
            ],
        )
    ...
    def test_lista_vazia_retorna_lista_vazia_e_media_zero(
        self, mock_get_object, mock_fato_compra, rf
    ):
    ...
    def test_ordem_dos_itens_preservada(self, mock_get_object, mock_fato_compra, rf):
        setup_mock_compras(
            ...
            [
                criar_mock_compra(
                    "PED01", emissao=date(2024, 1, 1), previsao=date(2024, 1, 5)
                ),
                criar_mock_compra(
                    "PED02", emissao=date(2024, 2, 1), previsao=date(2024, 2, 10)
                ),
            ],
        )
...
class TestEvolucaoGastosAPI:
    ...
    def test_mes_sem_dados_preenchido_com_zero(
        self, mock_get_object, mock_fato_compra, rf
    ):
        # Jan e Mar têm dados, Fev deve aparecer com 0.0
        dados = {(2024, 1): 150.0, (2024, 3): 200.0}
        setup_mock_gastos(
            mock_fato_compra, mock_get_object, dados, ano_inicio=2024, mes_inicio=1
        )
    ...
    def test_sem_lacunas_quando_todos_os_meses_tem_dados(
        self, mock_get_object, mock_fato_compra, rf
    ):
    ...
    def test_virada_de_ano_tratada_corretamente(
        self, mock_get_object, mock_fato_compra, rf
    ):
        dados = {(2023, 11): 500.0, (2024, 2): 300.0}
        setup_mock_gastos(
            mock_fato_compra, mock_get_object, dados, ano_inicio=2023, mes_inicio=11
        )
    ...
    def test_compra_antes_do_projeto_recua_o_inicio(
        self, mock_get_object, mock_fato_compra, rf
    ):
    ...
    def test_compra_no_mesmo_mes_do_inicio_nao_recua(
        self, mock_get_object, mock_fato_compra, rf
    ):
        dados = {(2024, 1): 100.0}
        setup_mock_gastos(
    ...
    def test_um_unico_mes_com_dados_retorna_lista_com_um_item(
        self, mock_get_object, mock_fato_compra, rf
    ):
        dados = {(2024, 6): 999.0}
        setup_mock_gastos(
            mock_fato_compra, mock_get_object, dados, ano_inicio=2024, mes_inicio=6
        )
    ...
    def test_mes_com_um_digito_formatado_com_zero_a_esquerda(
        self, mock_get_object, mock_fato_compra, rf
    ):
        dados = {(2024, 3): 100.0}
        setup_mock_gastos(
            mock_fato_compra, mock_get_object, dados, ano_inicio=2024, mes_inicio=3
        )
    ...
    def test_dados_vazios_retorna_lista_vazia(
        self, mock_get_object, mock_fato_compra, rf
    ):
        setup_mock_gastos(
            mock_fato_compra, mock_get_object, {}, ano_inicio=2024, mes_inicio=1
        )
